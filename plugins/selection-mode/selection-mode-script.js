...
function extractDOMContext(element) {
  ...
  return {
    ...
    textContent:
      ...
      textContent.length < TEXT_CONTEXT_MAX_LENGTH
...
function enableSelectionMode() {
  ...
  document
    .getElementById("root")
    ?.setAttribute(DATA_SELECTION_MODE_ENABLED_ATTRIBUTE, "true");
...
function disableSelectionMode() {
  ...
  document
    .getElementById("root")
    ?.removeAttribute(DATA_SELECTION_MODE_ENABLED_ATTRIBUTE);
